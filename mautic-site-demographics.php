<?php
/*
 *  Shows demographics for a site using WP Multisite and Mautic data.
 */
...
get_current_screen()->add_help_tab( array(
	'id'      => 'mautic-sync-demographics',
	'title'   => __( 'Overview' ),
	'content' =>
		'<p>' . __( '<strong>Mautic Demographics</strong> &mdash; This page shows the demographics of learners (with a current WordPress user account) associated with this Course'. '</p>')
    )
);
...
network_edit_site_nav( array(
	'blog_id'  => $id,
	'selected' => 'site-mautic-demographics'
) );
