...
get_current_screen()->add_help_tab( array(
	...
	'title'   => __( 'Overview' ),
	'content' =>
		'<p>' . __( '<strong>Mautic Sync</strong> &mdash; This page shows a list of learners (with a current WordPress user account) associated with this Course, and those who have corresponding Contacts in the OERu Mautic service that is used to communicate withe users via email. You can use this page to create a Mautic Segment corresponding to this Course, and automatically add the current users to that Segment.' ) . '</p>'
) );
